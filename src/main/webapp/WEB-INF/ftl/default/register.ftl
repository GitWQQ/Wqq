    ...
    <body id="body">
        <div class="page-container" style="margin: 100px auto 0px;">
            ...
            <form id="_form" action="" method="post">
                <input type="text" name="username" id="nickname" class="username"  placeholder="Nickname">
                ...
                <div style="text-align: left; margin-left: 10px;" id="vcode">
                	...
                	<img src="${basePath}/check/getGifCode.shtml"/>
                </div>
        ...
        <script>
			jQuery(document).ready(function() {
				...
				$("#vcode").on("click",'img',function(){
					var i = new Image();
					i.src = '${basePath}/check/getGifCode.shtml?'  + Math.random();
					$(i).replaceAll(this);
				});
			    $('.register').click(function(){
			    	...
			    	if(password != re_password){
			    		return layer.msg('秘密输入错误，请重新输入',function(){}),!1;
			    	}
			    	
			    	if($('[name=vcode]').val().length !=4){
			    		return layer.msg('验证码输入错误',function(){}),!1;
			    	}
			    	var load = layer.load();
			    	$.post("${basePath}/subRegister.shtml",$("#_form").serialize() ,function(result){
			    		layer.close(load);
